...
const FootballAiCoach = () => {
  return (
    <div className='bg-transparent flex flex-col items-center justify-center space-y-8 md:space-y-10 mb-16'>
      <h2 className='text-3xl md:text-[56px] text-center font-semibold text-[#FFFFFF] px-6'>
        The World&apos;s Only Football AI Coach!
      </h2>
      <p className='text-[20px] text-[#FFFFFF] max-w-2xl text-center px-6'>
